...
| [Systems Built Index](case-studies/systems-built-index.md) | Sanitized map of current systems and what they prove without exposing private code, customers, prompts, logs, or infrastructure. |
...
- 2026-06-02: [Systems Built Index](case-studies/systems-built-index.md)

## Artifacts

- [Sanitized production agent workflow diagram](assets/architecture-diagrams/production-agent-workflow.md)
- [Operator governance pattern diagram](assets/architecture-diagrams/operator-governance-pattern.md)
